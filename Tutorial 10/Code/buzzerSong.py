...
# Tutorial 10: Usar un zumbador para reproducir cancion
# Fuente: http://coding-talk.com/forum/main-forums/raspberry-pi/153268-play-super-mario-theme-with-passive-active-piezo-buzzer-on-your-raspberry-pi
...
def buzz(frequency, length):     #create the function "buzz" and feed it the pitch and duration)
    ...
    for i in range(numCycles):        #start a loop from 0 to the variable "cycles" calculated above
        GPIO.output(buzzer_pin, True)     #set pin 17 to high
        time.sleep(delayValue)        #wait with pin 17 high
        GPIO.output(buzzer_pin, False)        #set pin 17 to low
        time.sleep(delayValue)        #wait with pin 17 low
